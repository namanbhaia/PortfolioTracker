        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8">
                <div className="animate-pulse flex flex-col items-center">
                    ...
                    <div className="h-6 w-32 bg-slate-200 dark:bg-slate-800 rounded-md mb-2" />
                    <div className="h-4 w-48 bg-slate-100 dark:bg-slate-700 rounded-md" />
                </div>
            </div>
        );
    }
            ...
            <header className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-8">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight flex items-center gap-3">
                        <Wrench className="text-rose-600 dark:text-rose-500" size={32} />
                        Admin Controls
                    </h1>
