    ...
    return (
        <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 shadow-sm">
            <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h3 className="text-lg font-bold text-slate-900">BSE to NSE Migration</h3>
                    <p className="text-sm text-slate-500 font-medium">Standardize tickers across holding reports</p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-8 border-2 border-dashed border-slate-300 rounded-lg bg-white">
                <button
                    ...
                    disabled={loading}
                    className="px-6 py-2 bg-indigo-50 text-indigo-700 rounded-full font-bold text-sm border-0 hover:bg-indigo-100 transition-all disabled:opacity-50"
                >
                    {loading ? "Processing..." : "Run Migration"}
                </button>
                <p className="mt-3 text-[10px] text-slate-400 text-center px-4 tracking-[0.05em]">
