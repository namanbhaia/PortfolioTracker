            ...
            <div className="flex flex-col lg:flex-row flex-wrap lg:flex-nowrap items-center gap-2">
                ...
                <div className="flex p-1 bg-slate-100 rounded-xl shrink-0 overflow-x-auto max-w-full">
                    <button
                        ...
                        className={`px-2.5 py-1 text-[10px] font-bold rounded-lg transition-all whitespace-nowrap ${searchParams.get('is_long_term') === 'true'
                    ...
                    <button
                        ...
                        className={`px-3 py-1 text-[10px] font-bold rounded-lg transition-all whitespace-nowrap ${searchParams.get('is_long_term') === 'false'
                                ? 'bg-white shadow-sm text-indigo-600'
                                : 'text-slate-500'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-3 py-1 text-[10px] font-bold rounded-lg transition-all whitespace-nowrap ${!searchParams.get('is_long_term')
                                ? 'bg-white shadow-sm text-indigo-600'
                                : 'text-slate-500'
                            }`}
                    >
